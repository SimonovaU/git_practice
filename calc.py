...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(1141, 919)
        self.groupBox = QtWidgets.QGroupBox(Dialog)
        self.groupBox.setGeometry(QtCore.QRect(30, 70, 401, 271))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox.setTitle(_translate("Dialog", "Калькулятор"))
        ...
        self.label_4.setText(_translate("Dialog", "Произведение"))
        self.label_5.setText(_translate("Dialog", "Разность"))
        self.label_6.setText(_translate("Dialog", "Частное"))
